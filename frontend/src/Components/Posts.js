    ...
    {allPosts.map((posts,index) => {
        return (
          <div class="card bg-base-100 shadow-xl mt-3" id={index} key={index}>
            ...
            <div class="card-body lg:min-w-[70%]">
              <h2 class="card-title text-sm opacity-90">
                {"Author: " +
                  posts.address.slice(0, 3) +
                  "..." +
                  posts.address.slice(38, 42)}
              </h2>
              <h2 class="text-xs opacity-60">
              ...
              <div class="card-actions justify-end">
                ...
                >
                  <div className="text-lg">{posts.votes.toNumber()}</div>
                  <svg
